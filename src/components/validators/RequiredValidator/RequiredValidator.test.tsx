...
import { CheckBox, Form, FormProps, TextBox } from '../../basic-components';
...
describe('Required Validator - ', () => {
  it('Html Input elements must be validated ', () => {
    ...
    const requiredValidtorProps: BaseValidatorProps = {
      name: 'required_props',
    };
  ...
  it('When applied to checkbox then it should be validated for non-selection ', () => {
    ...
    const dom = render(
      <Form formProps={formProps}>
        <RequiredValidator
          requiredValidatorProps={requiredValidtorProps}
        ></RequiredValidator>
